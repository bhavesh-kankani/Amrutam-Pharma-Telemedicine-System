...
2. **Security Scan**: `uvx bandit -r backend/ -x "backend/accounts/tests.py,backend/consultations/tests.py,backend/analytics/tests.py,backend/compliance/tests.py"`
